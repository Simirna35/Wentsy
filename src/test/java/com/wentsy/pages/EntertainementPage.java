...
public class EntertainementPage extends BasePage{
    public EntertainementPage(BrowserUtils browserUtils, Driver driver, ConfigurationReader configurationReader) {
